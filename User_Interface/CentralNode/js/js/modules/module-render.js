...
var GetModuleData = React.createClass({
    ...
    setupAjax: function() {
        jQuery.ajax({
            url: 'http://192.168.0.200/node_api/module',
            dataType: 'json',
                            ...
                            <div className="row">
                                <div className="col-xs-9 text-left col-md-12">
                                    <span className="pull-right">
                                        ...
                                        <button type="button" className="btn btn-danger btn-circle" data-toggle="modal" onClick={this.editModuleModal.bind(this,data[i])} data-target="#removeModule">
    ...
    handleDeleteModule: function (event) {
      ...
      var url = 'http://192.168.0.200/node_api/module/' + this.state.enclosureNodeID;
    ...
    requestOverrideData: function(value){
        jQuery.ajax({
            url: 'http://192.168.0.200/node_api/overview/' + value.enclosureNodeID,
            dataType: 'json',
    ...
    handleModuleEditSubmit: function (event) {
       event.preventDefault();
        ...
        if(canProceed) {
          ...
          jQuery.ajax({
            url: 'http://192.168.0.200/node_api/module/' + this.state.enclosureNodeID,
            dataType: 'json',
            type: 'PUT',
            contentType: 'application/json',
            data: JSON.stringify( modData ),

              complete: this.handleEditModule
          });
        } 
    },
    ...
    handleOverrideSubmit: function (e) {
       ...
       if(this.state.OPTIONAL_OR){
        ...
        jQuery.ajax({
            url: 'http://192.168.0.200/node_api/override/' + this.state.enclosureNodeID,
            dataType: 'json',
            type: 'POST',
            contentType: 'application/json',
            data: JSON.stringify( overrideData ),

            complete: this.handleSuccessOverride
        });
    },
